...
var Rule = /** @class */ (function (_super) {
    ...
    Rule.prototype.apply = function (sourceFile) {
        ...
        var ignoreAngularLifecycleProperty = options.indexOf(OPTION_IGNORE_ANGULAR_LIFECYCLE) !== -1;
        if (noPublic) {
    ...
    Rule.metadata = {
        ...
        optionExamples: [
            true,
            [true, OPTION_NO_PUBLIC],
            [true, OPTION_CHECK_ACCESSOR]
        ],
        type: 'typescript',
        typescriptOnly: true,
        hasFix: true
...
exports.Rule = Rule;
function walk(ctx) {
    var _a = ctx.options, noPublic = _a.noPublic, checkAccessor = _a.checkAccessor, checkConstructor = _a.checkConstructor, checkParameterProperty = _a.checkParameterProperty, ignoreAngularLifecycleProperty = _a.ignoreAngularLifecycleProperty;
        ...
        if (!noPublic && publicKeyword === undefined) {
            var nameNode = node.kind === ts.SyntaxKind.Constructor
                ...
                : node.name !== undefined
                    ? node.name
                    : node;
            var memberName = node.name !== undefined &&
                node.name.kind === ts.SyntaxKind.Identifier
                ? node.name.text
                : undefined;
            if (ignoreAngularLifecycleProperty &&
